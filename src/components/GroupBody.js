...
const GroupBody = () => {
    ...
    return (
        <div className="container mx-auto md:max-w-screen-md  lg:max-w-screen-lg flex flex-col-reverse sm:flex-row my-12 mt-24 space-x-8 justify-center space-y-8 sm:space-y-0">
